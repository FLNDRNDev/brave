  ...
  theme: {
    extend: {
      colors: {
        ...
        // Brand colors
        brand: {
          DEFAULT: "oklch(var(--brand))", // #1da1f2 (light) / #1da1f2 (dark)
          light: "oklch(var(--brand-light))", // #4db5f5 (light) / #4db5f5 (dark)
          dark: "oklch(var(--brand-dark))", // #0d8bd9 (light) / #0d8bd9 (dark)
        },
        // CTA colors
        cta: {
